...
describe('SearchBar', () => {
    it('renders platform options and triggers callbacks', async () => {
        ...
        render(_jsx(SearchBar, { platform: "youtube", onPlatformChange: onPlatformChange, defaultValue: "Apple", onSearch: onSearch, history: ["Apple Vision Pro", "Oculus"], onHistorySelect: onHistorySelect }));
