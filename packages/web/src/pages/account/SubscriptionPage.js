...
const planBenefitMap = {
    MONTHLY_BASIC: {
        title: '月度会员',
        benefits: ['2 个关键词', '每日 2 个执行时间', '飞书 + 邮件通知']
    },
    YEARLY_BASIC: {
        title: '年度会员',
        benefits: ['10 个关键词', '每日 5 个执行时间', '立省 17%，一次付清']
    }
};
...
const getPlanBenefits = (plan) => planBenefitMap[plan.code]?.benefits ?? planBenefitMap.MONTHLY_BASIC.benefits;
export function SubscriptionPage() {
    ...
    const checkoutQrData = useMemo(() => {
        if (!checkoutInfo) {
            return null;
        }
        return checkoutInfo.wechat?.codeUrl ?? checkoutInfo.alipay?.qrCode ?? checkoutInfo.mock?.paymentUrl ?? null;
    }, [checkoutInfo]);
    ...
    return (_jsxs("div", { className: "subscription-page", children: [_jsxs("header", { className: "subscription-header", children: [_jsxs("div", { children: [_jsx("h1", { children: "\u4F1A\u5458\u8BA2\u9605\u4E0E\u652F\u4ED8" }), _jsx("p", { children: "\u9009\u62E9\u6708\u5EA6\u6216\u5E74\u5EA6\u4F1A\u5458\uFF0C\u70B9\u51FB\u201C\u8BA2\u9605\u201D\u540E\u7ACB\u5373\u8DF3\u8F6C\u5230\u652F\u4ED8\u4E8C\u7EF4\u7801\u3002" })] }), _jsx(Link, { to: "/app", className: "account-banner__link account-banner__link--muted", children: "\u8FD4\u56DE\u63A7\u5236\u53F0" })] }), loading === 'loading' ? _jsx("div", { className: "subscription-card", children: "\u52A0\u8F7D\u4E2D\u2026" }) : null, error ? _jsx("div", { className: "subscription-error", children: error }) : null, providerStatusLoading ? _jsx("div", { className: "plan-meta", children: "\u6B63\u5728\u68C0\u6D4B\u652F\u4ED8\u65B9\u5F0F\u914D\u7F6E\u2026" }) : null, providerStatusError ? _jsx("div", { className: "subscription-error", children: providerStatusError }) : null, noRealProvider ? _jsx("div", { className: "plan-meta plan-meta--warning", children: "\u672A\u914D\u7F6E\u771F\u5B9E\u652F\u4ED8\u901A\u9053\uFF0C\u5F53\u524D\u73AF\u5883\u5C06\u4F7F\u7528\u6A21\u62DF\u652F\u4ED8\u3002" }) : null, _jsx("section", { className: "subscription-grid", style: { gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }, children: paidPlans.length === 0 ? (_jsx("div", { className: "subscription-card", children: _jsx("p", { children: "\u6682\u65E0\u53EF\u8D2D\u4E70\u7684\u4F1A\u5458\u5957\u9910\uFF0C\u8BF7\u7A0D\u540E\u518D\u8BD5\u3002" }) })) : (paidPlans.map((plan) => {
                ...
                })) }), checkoutPlan ? (_jsx("div", { className: "subscription-modal", children: _jsxs("div", { className: "subscription-modal__card", children: [_jsxs("div", { className: "checkout-panel__header", children: [_jsxs("div", { children: [_jsx("strong", { children: "\u652F\u4ED8\u4E8C\u7EF4\u7801" }), _jsxs("p", { className: "plan-meta", children: ["\u8BA2\u5355\u53F7\uFF1A", checkoutInfo?.outTradeNo ?? '生成中…'] })] }), _jsx("button", { type: "button", className: "subscription-modal__close", onClick: stopCheckout, children: "\u5173\u95ED" })] }), _jsxs("div", { className: "qr-preview__amount", children: [_jsx("span", { children: "\u5E94\u4ED8\u91D1\u989D" }), _jsx("strong", { children: formatAmount(checkoutPlan.price_cents) })] }), checkoutQrData ? (_jsxs(_Fragment, { children: [_jsx("img", { className: "qr-preview__image", src: `https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=${encodeURIComponent(checkoutQrData)}`, alt: "\u652F\u4ED8\u4E8C\u7EF4\u7801" }), _jsxs("p", { className: "qr-preview__hint", children: ["\u8BF7\u4F7F\u7528", providerLabel ?? '对应', "\u626B\u7801\u5B8C\u6210\u652F\u4ED8\uFF0C\u5B8C\u6210\u540E\u7CFB\u7EDF\u4F1A\u81EA\u52A8\u5237\u65B0\u8BA2\u9605\u72B6\u6001\u3002"] })] })) : (_jsx("p", { className: "qr-preview__hint", children: "\u6B63\u5728\u751F\u6210\u4E8C\u7EF4\u7801\uFF0C\u8BF7\u7A0D\u5019\u2026" })), checkoutError ? _jsx("div", { className: "subscription-error", children: checkoutError }) : null, _jsxs("div", { className: "manual-verify-hint", children: [_jsx("p", { children: "\u652F\u4ED8\u5B8C\u6210\u540E\uFF0C\u8BF7\u626B\u7801\u6DFB\u52A0\u5BA2\u670D\u5FAE\u4FE1\uFF0C\u63D0\u4F9B\u652F\u4ED8\u622A\u56FE\u548C\u8D26\u53F7\u4FE1\u606F\uFF0C\u5373\u53EF\u7ACB\u5373\u5F00\u901A\u4F1A\u5458\u6743\u9650\u3002" }), _jsx("img", { className: "manual-verify-hint__qr", src: "/assets/support-wechat.png", alt: "\u5BA2\u670D\u5FAE\u4FE1\u4E8C\u7EF4\u7801" })] }), _jsx("button", { type: "button", className: "btn secondary", onClick: () => void loadSubscriptionData(), children: "\u5DF2\u652F\u4ED8\uFF0C\u5237\u65B0\u72B6\u6001" })] }) })) : null] }));
}
