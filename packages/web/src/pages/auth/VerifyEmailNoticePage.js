...
export function VerifyEmailNoticePage() {
    ...
    return (_jsx(AuthLayout, { title: "\u9A8C\u8BC1\u60A8\u7684\u90AE\u7BB1", subtitle: `我们已将验证邮件发送至 ${user.email}`, footer: _jsxs("div", { className: "auth-form__footer", children: [_jsx("span", { children: "\u5DF2\u7ECF\u5B8C\u6210\u9A8C\u8BC1\uFF1F" }), _jsx(Link, { to: "/login", children: "\u8FD4\u56DE\u767B\u5F55" })] }), children: _jsxs("div", { className: "auth-notice auth-notice--compact", children: [_jsx("p", { children: "\u8BF7\u524D\u5F80\u90AE\u7BB1\u70B9\u51FB\u9A8C\u8BC1\u94FE\u63A5\uFF0C\u94FE\u63A5\u6709\u6548\u671F 24 \u5C0F\u65F6\u3002" }), _jsxs("p", { className: "auth-notice__alert", children: [_jsx("strong", { children: "\u6CE8\u610F\uFF1A" }), "\u6536\u4EF6\u7BB1\u6CA1\u770B\u5230\uFF0C\u8BF7\u68C0\u67E5\u201C\u5783\u573E\u90AE\u4EF6/\u5783\u573E\u7BB1\u201D\u6216\u5176\u4ED6\u5206\u7C7B\uFF1B\u82E5\u4ECD\u672A\u6536\u5230\uFF0C\u53EF\u7A0D\u540E\u518D\u8BD5\u6216\u70B9\u51FB\u4E0B\u65B9\u6309\u94AE\u91CD\u65B0\u53D1\u9001\u3002"] }), message ? (_jsx("div", { className: `auth-notice__message auth-notice__message--${status === 'error' ? 'error' : 'success'}`, children: message })) : null, _jsx("button", { type: "button", className: "auth-form__submit", onClick: handleResend, disabled: status === 'loading', children: status === 'loading' ? '发送中...' : '重新发送验证邮件' })] }) }));
}
