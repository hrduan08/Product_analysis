...
export function VerifyEmailCallbackPage() {
    ...
    return (_jsx(AuthLayout, { title: TEXT.title, subtitle: TEXT.subtitle, children: _jsxs("div", { className: "auth-notice", children: [_jsx("p", { children: message ?? TEXT.verifying }), status === 'loading' ? null : (_jsx("div", { className: "auth-notice__actions", children: status === 'success' ? (_jsx(Link, { to: "/login", className: "auth-form__submit auth-form__submit--link", children: TEXT.backLogin })) : (_jsx(Link, { to: "/verify-email", className: "auth-form__submit auth-form__submit--link", children: TEXT.resend })) }))] }) }));
}
