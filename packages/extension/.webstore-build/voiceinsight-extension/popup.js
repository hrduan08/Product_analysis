...
const I18N = {
  zh: {
    ...
    error_captions_not_found: "该视频没有可用字幕或字幕暂不可用。",
  ...
  en: {
    app_title: "VoiceInsight",
    app_subtitle: "YouTube Subtitle Downloader",
    lang_zh: "中文",
    lang_en: "EN",
    lang_toggle_aria: "Language",
    action_download: "Download Subtitles/CC",
    ...
    error_captions_not_found: "No subtitles available for this video.",
...
const ZH_ERROR_KEYWORDS = [
  { pattern: /没有可用字幕|字幕暂不可用|该视频没有可用字幕/, key: "error_captions_not_found" },
...
function formatErrorMessage(error) {
  ...
  if (lower.includes("captions_not_found") || lower.includes("no captions")) {
